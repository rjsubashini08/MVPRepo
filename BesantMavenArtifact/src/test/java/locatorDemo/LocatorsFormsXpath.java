...
public class LocatorsFormsXpath {
	...
	public void validateForms() throws InterruptedException
	{
		...
		WebElement textBoxEle=driver.findElement(By.xpath("//input[@id='uname']"));
		textBoxEle.sendKeys("Pallavi");
		Thread.sleep(3000);
//		driver.findElement(By.id("username")).sendKeys("Pallavi");
		
		WebElement txtpswd=driver.findElement(By.xpath("//input[@name='password']"));
		txtpswd.sendKeys("subashini");
		
		WebElement classObj=driver.findElement(By.xpath("//input[@class='xyz_gi']"));
		classObj.sendKeys("subashini");
		
		WebElement ancObj=driver.findElement(By.xpath("//a[contains(text(),'User Login')]"));
		ancObj.click();
